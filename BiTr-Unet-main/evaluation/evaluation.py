...
def get_ground_truth_names(g_folder, patient_names_file):
    ...
    for patient_name in patient_names:
        patient_dir = os.path.join(g_folder, "Copy of " + patient_name + "_seg.nii")
        gt_name = patient_dir
...
if __name__ == '__main__':
    ...
    s_folder = '/content/drive/Shareddrives/cs231n_final/BiTr-Unet-main/output/submission/BiTrUnet20232023-06-08/'
    g_folder = '/content/drive/Shareddrives/cs231n_final/ground_truth/'
    patient_names_file = '/content/names.txt'
