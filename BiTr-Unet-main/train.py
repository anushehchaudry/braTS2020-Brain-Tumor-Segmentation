...
# DataSet Information
parser.add_argument('--main_path', default="/content/drive/Shareddrives/cs231n_final/cs231n_baseline/BraTS2020/", type=str)

parser.add_argument('--root', default="/content/drive/Shareddrives/cs231n_final/cs231n_baseline/BraTS2020/", type=str)
...
parser.add_argument('--train_file', default='/content/train.txt', type=str)

parser.add_argument('--valid_file', default='/content/official_valid.txt', type=str)
